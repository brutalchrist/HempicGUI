...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile hempicGUI.pro
#############################################################################
...
SOURCES       = main.cpp \
		hempicgui.cpp qrc_resources.cpp \
		moc_hempicgui.cpp
OBJECTS       = main.o \
		hempicgui.o \
		qrc_resources.o \
...
Makefile: hempicGUI.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile hempicGUI.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/hempicGUI1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/hempicGUI1.0.0/ && $(COPY_FILE) --parents hempicgui.h .tmp/hempicGUI1.0.0/ && $(COPY_FILE) --parents main.cpp hempicgui.cpp .tmp/hempicGUI1.0.0/ && $(COPY_FILE) --parents hempicgui.ui .tmp/hempicGUI1.0.0/ && (cd `dirname .tmp/hempicGUI1.0.0` && $(TAR) hempicGUI1.0.0.tar hempicGUI1.0.0 && $(COMPRESS) hempicGUI1.0.0.tar) && $(MOVE) `dirname .tmp/hempicGUI1.0.0`/hempicGUI1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/hempicGUI1.0.0
...
compiler_moc_header_make_all: moc_hempicgui.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_hempicgui.cpp
...
compiler_uic_make_all: ui_hempicgui.h
compiler_uic_clean:
	-$(DEL_FILE) ui_hempicgui.h
